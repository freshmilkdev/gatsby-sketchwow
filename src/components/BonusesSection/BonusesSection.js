...
export const BonusesSection = () => (<WaveHeaderSection color={'sand'} withPointer>
    ...
    <div className={styles.bonuses}>
        ...
        <BonusRow heading={'AI Animations & Presentations'}
                  ...
                  text={<>
                      <p>
                          You already know that Artificial Intelligence (AI) is a hot topic right now. If you do your
                          homework… you’ll find AI presentation and <strong>AI animation software that costs $144-$300+
                          PER YEAR.</strong> Yikes! Who has that kind of spare change lying around, right?
                      </p>
                      <p>We are currently working to add AI to SketchWow Animate. When we do… two things are guaranteed to happen:</p>
